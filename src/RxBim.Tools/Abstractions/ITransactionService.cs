namespace RxBim.Tools
{
    ...
    public interface ITransactionService
    {
        ...
        /// <param name="document">
        ///     The owner(document, drawing database, etc.) on which the action is performed.
        ///     If null, runs in the current target.
        /// </param>
        void RunInTransaction(Action action, string? transactionName = null, object? document = null);
        ...
        T RunInTransaction<T>(Func<T> func, string? transactionName = null, object? document = null);
        ...
        ///     If null, runs in the current target.
        /// </param>
        void RunInTransactionGroup(Action action, string transactionGroupName, object? document = null);
        ...
        ///     If null, runs in the current target.
        /// </param>
        T RunInTransactionGroup<T>(Func<T> func, string transactionGroupName, object? document = null);
    }
}